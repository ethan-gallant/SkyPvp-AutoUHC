...
public class UHCJedis {
	...
	public void announceServerDetails(Jedis jedis) {
		...
		p.hset(serverName, GAME_MODE_KEY, (profile.isTeamMatch()) ? "team" : "ffa");
	...
	public void updateStatus() {
		...
		try(Jedis jedis = pool.getResource()) {
			...
			if(exists) {
				jedis.hset(serverName, GAME_STATE_KEY, 
						String.valueOf(main.getGameStateManager()
								.getActiveState().toIndex()));
